...
class Recipe:
  ...
  def public_recipe(self):
    print("\033[35m {}" .format(self.name.upper() + '!'))
    print("\033[35m {}" .format(self.ingredients.upper() + '!'))
    print("\033[35m {}" .format(self.annotation.upper() + '!'))
    print("\033[35m {}" .format(self.cooking_time.upper() + '!'))
    print("\033[35m {}" .format(self.cooking_device.upper() + '!'))
